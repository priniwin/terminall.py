...
while lance == True:
    ...
    if saisi == "quiter":
        ...
        print("quiter,hello,help,acount,descri,conect")
    elif saisi == "acount":
        identifiant = input("cree votre identifiant : ")
        password = input("cree votre mot de passe : ")
        print("bienvenue")
    elif saisi == "descri":
        print("quiter permet de quiter le programme,hello afiche un message de bienvenue,help affiche toute les commande, acount sert a cree sont compte et conect permet de se conecter")
    elif saisi == "conect":
